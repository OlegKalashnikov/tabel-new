    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Отделения</a></li>
            </ol>
        </div>
    </div>
    <!-- ============================================================== -->
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card card-body">
                <p class="text-muted m-b-30 font-13"> Импорт списков отделений из файл .csv .xls .xlsx</p>
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        <form method="POST" action="{{route('settings.department.upload')}}" enctype="multipart/form-data" class="form-material">
                            @csrf
