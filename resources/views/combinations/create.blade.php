            ...
            <div class="card card-body">
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        <form method="POST" action="{{route('combination.store')}}" class="form-material">
                            @csrf
                            ...
                            <div class="form-group">
                                <input type="text" name="percentages" class="form-control" placeholder="Укажите процент совмещения">
                            </div>
                            <div class="form-group">
                                <input type="text" name="start" class="form-control" placeholder="Укажите дату начала периода" id="mdate_start">
                            </div>
                            <div class="form-group">
                                <input type="text" name="end" class="form-control" placeholder="Укажите дату конца периода" id="mdate_end">
                            </div>
